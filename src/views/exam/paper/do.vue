    ...
    initAnswer () {
      ...
      for (let tIndex in titleItemArray) {
        ...
        for (let qIndex in questionArray) {
          ...
          this.answer.answerItems.push({ questionId: question.id, questionTypeEnum: question.questionType, content: null, contentArray: [], completed: false, itemOrder: question.itemOrder })
        }
      }
    },
    submitForm () {
